...
class WittyBlockNewsletter extends Module
{
	...
	{
		$this->name = 'wittyblocknewsletter';
		$this->tab = 'witty_front_features';
		$this->need_instance = 0;

		parent::__construct();

		$this->displayName = $this->l('Bloc Newsletter');
		$this->description = $this->l('Ajoute un bloc pour la souscription à la newsletter');
	...
	{
		if (parent::install() == false || $this->registerHook('footer') == false)
			return false;
	...
	public function hookDisplayFooter($params)
	{
		...
		$this->context->controller->addCSS($this->_path.'static/css/wittyblocknewsletter.css', 'all');
		return $this->display(__FILE__, 'wittyblocknewsletter.tpl');
	}
}
