...
class WittyBlockNewProducts extends Module
{
	public function __construct()
	{
		$this->name = 'wittyblocknewproducts';
		$this->tab = 'witty_front_features';
		$this->version = 1.0;
		...
		$this->displayName = $this->l('Bloc des nouveaux produits');
		$this->description = $this->l('Ajoute un bloc qui montre les nouveaux produits');
	}
	...
	public function hookHome($params)
	{
		...
		$this->context->controller->addCSS(($this->_path).'static/css/wittyblocknewproducts.css', 'all');
		
		return $this->display(__FILE__, 'wittyblocknewproducts.tpl');
	}

	/* Pour l'instant pas de présence ailleurs qu'en bloc central
