...
class WittyBlockBestSellers extends Module
{
	private $_html = '';
	...
	{
		$this->name = 'wittyblockbestsellers';
		$this->tab = 'witty_front_feature';
		$this->version = '1.0';
		...
		$this->displayName = $this->l('Bloc meilleures ventes');
		$this->description = $this->l('Ajoute un bloc qui affiche les meilleures ventes de la boutique');
	}
	...
	*/
	...
	public function hookHome($params)
	{
		...
		$this->context->controller->addCSS(($this->_path).'static/css/wittyblockbestsellers.css', 'all');
	
		return $this->display(__FILE__, 'wittyblockbestsellers-home.tpl');
	}
}
